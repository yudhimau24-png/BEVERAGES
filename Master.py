...
st.markdown(
    ...
    <div class="hero-container">
        ...
        <div class="hero-subtitle">Automated Master Sommelier Analysis • Market Benchmarking • HORECA Intelligence</div>
        <div>
            <span class="badge-pill">⚡ YM's 3.6 PRO ENGINE ACTIVE</span>
            <span class="badge-pill badge-pill-cyan">🛡️ NO HALLUCINATION ON</span>
        </div>
    </div>
    """,
    unsafe_allow_html=True
...
# =========================================================
# TOMBOL PILIHAN BAHASA SIDEBAR (CLEAN & NON-DISRUPTIVE)
# =========================================================
...
if btn_process:
    if not api_key:
        ...
        # Penyesuaian Instruksi Bahasa AI secara Bersih & Terisolasi
